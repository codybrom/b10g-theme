...
if (toc) {
  // The disclosure's open state is settled during parsing, by the inline script
  // rail.html emits next to it — doing it here meant it changed after the first
  // paint, and the article jumped as the list collapsed.
